...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Master Masjid</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<script>
    function dataTabel() {
        ...
        $('#table-10').DataTable({
            destroy: true,
            "ajax": {
                url: "<?= base_url('admin/dinamis/load_master_masjid'); ?>",
                type: "POST",
                data: {
                    masjid: "all"
                },
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "mRender": function(data, type, full) {
                        return '<button value="' + full['id'] + '" class="btn btn-sm btn-info" onclick="detail(this.value);"><i class="bi bi-arrow-right-circle"></i>';
                    },
                    className: 'align-top'
                },
                {
                    ...
                    "bSortable": false,
                    "mRender": function(data, type, full) {
                        return '<button value="' + full['id'] + '" class="btn btn-sm btn-warning" onclick="edit(this.value);"><i class="bi bi-pencil-square"></i></button>';
                    },
                    className: 'align-top'
                },
                {
                    ...
                    "bSortable": false,
                    "mRender": function(data, type, full) {
                        return '<button value="' + full['id'] + '" class="btn btn-sm btn-danger" onclick="hapus(this.value);"><i class="bi bi-trash"></i></button>';
                    },
                    className: 'align-top'
                }
            ],
