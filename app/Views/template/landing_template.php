            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            <div class="col-lg-6">
                                <img src="<?= base_url(); ?>/assetslanding/img/about-company-1.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="row gy-4">
                                    <div class="col-lg-12">
                                        <img src="<?= base_url(); ?>/assetslanding/img/about-company-2.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="col-lg-12">
                                        <img src="<?= base_url(); ?>/assetslanding/img/about-company-3.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="<?= base_url(); ?>/assetslanding/img/clients/client-1.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="<?= base_url(); ?>/assetslanding/img/clients/client-2.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="<?= base_url(); ?>/assetslanding/img/clients/client-3.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="<?= base_url(); ?>/assetslanding/img/clients/client-4.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="<?= base_url(); ?>/assetslanding/img/clients/client-5.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->

                    <div class="col-xl-2 col-md-3 col-6 client-logo">
                        <img src="<?= base_url(); ?>/assetslanding/img/clients/client-6.png" class="img-fluid" alt="">
                    </div><!-- End Client Item -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="tab-pane fade active show" id="features-tab-1">
                                <img src="<?= base_url(); ?>/assetslanding/img/tabs-1.jpg" alt="" class="img-fluid">
                            </div><!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-2">
                                <img src="<?= base_url(); ?>/assetslanding/img/tabs-2.jpg" alt="" class="img-fluid">
                            </div><!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-3">
                                <img src="<?= base_url(); ?>/assetslanding/img/tabs-3.jpg" alt="" class="img-fluid">
                            </div><!-- End Tab Content Item -->
                        </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <img src="<?= base_url(); ?>/assetslanding/img/features-1.jpg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                        <img src="<?= base_url(); ?>/assetslanding/img/features-2.jpg" class="img-fluid" alt="">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="features-image col-lg-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                        <img src="<?= base_url(); ?>/assetslanding/img/features-3.jpg" alt="">
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="<?= base_url(); ?>/assetslanding/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                                    <h3>Saul Goodman</h3>
                                    <h4>Ceo &amp; Founder</h4>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="<?= base_url(); ?>/assetslanding/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="<?= base_url(); ?>/assetslanding/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="<?= base_url(); ?>/assetslanding/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="<?= base_url(); ?>/assetslanding/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                </div>
                            </div>
